...
int col_int_rand(col_int *arr,const col_uint *idx, int min, int max, unsigned int num);
...
int col_uint_subset_assign_scalar (col_uint * arr, const col_uint * idx, unsigned int value);
